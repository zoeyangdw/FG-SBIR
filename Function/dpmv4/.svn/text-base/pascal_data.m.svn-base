...
try
  ...
  for i = 1:length(ids);
    ...
    for j = clsinds(:)'
     ...
     %pos(numpos).im = ['/home/hosseina/data/voc/VOCdevkit/VOC2007/JPEGImages/' rec.imgname];
  ...
  for i = 1:length(ids);
    ...
    if length(clsinds) == 0
      ...
      %neg(numneg).im = ['/home/hosseina/data/voc/VOCdevkit/VOC2007/JPEGImages/' rec.imgname];
